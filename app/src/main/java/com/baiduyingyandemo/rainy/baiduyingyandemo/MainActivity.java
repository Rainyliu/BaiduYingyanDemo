package com.baiduyingyandemo.rainy.baiduyingyandemo;
...
import com.baiduyingyandemo.rainy.baiduyingyandemo.fragment.TrackQueryFragment;
import com.baiduyingyandemo.rainy.baiduyingyandemo.fragment.TrackUploadFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initComponent() {
        ...
        traceApp.initBmap((MapView) findViewById(R.id.bmapView));
        ...
        switch (id) {
            ...
            case R.id.btn_trackQuery:
                ...
                if (mTrackQueryFragment == null) {
                    mTrackQueryFragment = TrackQueryFragment.newInstance(traceApp);
                ...
                traceApp.getmBaiduMap().setOnMapClickListener(null);
                break;
            ...
            case R.id.btn_trackUpload:
                ...
                if (mTrackUploadFragment == null) {
                    mTrackUploadFragment = TrackUploadFragment.newInstance(traceApp);
    ...
    private void hideFragments(FragmentTransaction transaction) {
        ...
        // 清空地图覆盖物
        traceApp.getmBaiduMap().clear();
    }

    @Override
    protected void onResume() {
        traceApp.getBmapView().onResume();
        super.onResume();
    }
    ...
    protected void onDestroy() {
        // TODO Auto-generated method stub
        super.onDestroy();
        traceApp.getClient().onDestroy();
        traceApp.getBmapView().onDestroy();
